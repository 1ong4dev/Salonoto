...
<head>
    ...
    <link rel="icon" href="Salon/assets/img/favicon.png" />
    <link rel="stylesheet" href="/Salon/assets/css/style.css">
</head>
        ...
        if ($pass_1 == $pass_2 && $pass_1 != '') {
            ...
            if (count(Database::GetData($sql))) {
                ...
                if (Database::NonQuery($sql)) {
                    ...
                    header('Location: /Salon/logout.php');
                }
            } else {
        ...
        <form class="profile__form--body" method="POST">
            ...
            <div class="profile__group d-flex-center">
                <div>
                    ...
                    <a class="btn" href="/Salon/profile.php">Thông tin cá nhân</a>
